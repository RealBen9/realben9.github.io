(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["firebase-messaging"], {
    "741f": function(e, t, n) {
        "use strict";
        n.r(t);
        var r, o, i, s = n("c23d"), a = n.n(s), c = n("9ab4"), u = n("cd51"), d = (r = {},
        ...
        r["should-be-overriden"] = "This method should be overriden by extended classes.",
        r["bad-sender-id"] = "Please ensure that 'messagingSenderId' is set correctly in the options passed into firebase.initializeApp().",
        r["permission-default"] = "The required permissions were not granted and dismissed instead.",
        r["permission-blocked"] = "The required permissions were not granted and blocked instead.",
        r["unsupported-browser"] = "This browser doesn't support the API's required to use the firebase SDK.",
        r["notifications-blocked"] = "Notifications have been blocked.",
        r["failed-serviceworker-registration"] = "We are unable to register the default service worker. {$browserErrorMessage}",
        r["sw-registration-expected"] = "A service worker registration was the expected input.",
        r["get-subscription-failed"] = "There was an error when trying to get any existing Push Subscriptions.",
        r["invalid-saved-token"] = "Unable to access details of the saved token.",
        r["sw-reg-redundant"] = "The service worker being used for push was made redundant.",
        r["token-subscribe-failed"] = "A problem occured while subscribing the user to FCM: {$errorInfo}",
        r["token-subscribe-no-token"] = "FCM returned no token when subscribing the user to push.",
        r["token-subscribe-no-push-set"] = "FCM returned an invalid response when getting an FCM token.",
        r["token-unsubscribe-failed"] = "A problem occured while unsubscribing the user from FCM: {$errorInfo}",
        r["token-update-failed"] = "A problem occured while updating the user from FCM: {$errorInfo}",
        r["token-update-no-token"] = "FCM returned no token when updating the user to push.",
        r["use-sw-before-get-token"] = "The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used.",
        r["invalid-delete-token"] = "You must pass a valid token into deleteToken(), i.e. the token from getToken().",
        r["delete-token-not-found"] = "The deletion attempt for token could not be performed as the token was not found.",
        r["delete-scope-not-found"] = "The deletion attempt for service worker scope could not be performed as the scope was not found.",
        r["bg-handler-function-expected"] = "The input to setBackgroundMessageHandler() must be a function.",
        r["no-window-client-to-msg"] = "An attempt was made to message a non-existant window client.",
        r["unable-to-resubscribe"] = "There was an error while re-subscribing the FCM token for push messaging. Will have to resubscribe the user on next visit. {$errorInfo}",
        r["no-fcm-token-for-resubscribe"] = "Could not find an FCM token and as a result, unable to resubscribe. Will have to resubscribe the user on next visit.",
        r["failed-to-delete-token"] = "Unable to delete the currently saved token.",
        r["no-sw-in-reg"] = "Even though the service worker registration was successful, there was a problem accessing the service worker itself.",
        r["bad-scope"] = "The service worker scope must be a string with at least one character.",
        r["bad-vapid-key"] = "The public VAPID key is not a Uint8Array with 65 bytes.",
        r["bad-subscription"] = "The subscription must be a valid PushSubscription.",
        r["bad-token"] = "The FCM Token used for storage / lookup was not a valid token string.",
        r["bad-push-set"] = "The FCM push set used for storage / lookup was not not a valid push set string.",
        r["failed-delete-vapid-key"] = "The VAPID key could not be deleted.",
        r["invalid-public-vapid-key"] = "The public VAPID key must be a string.",
        r["use-public-key-before-get-token"] = "The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used.",
        r["public-vapid-key-decryption-failed"] = "The public VAPID key did not equal 65 bytes when decrypted.",
        r), f = new u["ErrorFactory"]("messaging","Messaging",d), h = new Uint8Array([4, 51, 148, 247, 223, 161, 235, 177, 220, 3, 162, 94, 21, 113, 219, 72, 211, 46, 237, 237, 178, 52, 219, 183, 71, 58, 12, 143, 196, 204, 225, 111, 60, 140, 132, 223, 171, 182, 102, 62, 242, 12, 212, 139, 254, 227, 249, 118, 47, 20, 28, 99, 8, 106, 111, 45, 177, 26, 149, 176, 206, 55, 192, 156, 110]), l = "https://fcm.googleapis.com";
        /**
 * @license
 ...
 */
        function b(e) {
            ...
            return btoa(String.fromCharCode.apply(String, Object(c["__spread"])(t)))
        }
        function g(e) {
            var t = b(e);
        ...
        var w = function() {
            ...
            return e.prototype.getToken = function(e, t, n) {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    var r, o, i, s, a, u, d, b, w, v;
                    return Object(c["__generator"])(this, (function(c) {
                        switch (c.label) {
                        case 0:
                            r = g(t.getKey("p256dh")),
                            o = g(t.getKey("auth")),
                            i = "authorized_entity=" + e + "&endpoint=" + t.endpoint + "&encryption_key=" + r + "&encryption_auth=" + o,
                            p(n.buffer, h.buffer) || (s = g(n),
                            i += "&application_pub_key=" + s),
                            a = new Headers,
                        ...
                        case 1:
                            ...
                            [4, fetch(l + "/fcm/connect/subscribe", u)];
                        case 2:
                            return b = c.sent(),
                            [4, b.json()];
                        case 3:
            ...
            e.prototype.updateToken = function(e, t, n, r, o) {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    var i, s, a, u, d, b, w, v, _, y;
                    return Object(c["__generator"])(this, (function(c) {
                        switch (c.label) {
                        case 0:
                            i = g(r.getKey("p256dh")),
                            s = g(r.getKey("auth")),
                            a = "push_set=" + n + "&token=" + t + "&authorized_entity=" + e + "&endpoint=" + r.endpoint + "&encryption_key=" + i + "&encryption_auth=" + s,
                            p(o.buffer, h.buffer) || (u = g(o),
                            a += "&application_pub_key=" + u),
                            d = new Headers,
                        ...
                        case 1:
                            return c.trys.push([1, 4, , 5]),
                            [4, fetch(l + "/fcm/connect/subscribe", b)];
                        case 2:
                            return v = c.sent(),
                            [4, v.json()];
                        case 3:
            ...
            e.prototype.deleteToken = function(e, t, n) {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    ...
                    return Object(c["__generator"])(this, (function(c) {
                        ...
                        case 1:
                            return c.trys.push([1, 4, , 5]),
                            [4, fetch(l + "/fcm/connect/unsubscribe", i)];
                        case 2:
                            return s = c.sent(),
                            [4, s.json()];
                        case 3:
 ...
 */
        function v(e) {
            for (var t = "=".repeat((4 - e.length % 4) % 4), n = (e + t).replace(/\-/g, "+").replace(/_/g, "/"), r = atob(n), o = new Uint8Array(r.length), i = 0; i < r.length; ++i)
                o[i] = r.charCodeAt(i);
            return o
        }
        /**
 ...
 */
        ...
        function k(e) {
            if (e.objectStoreNames.contains(y)) {
                var t = e.transaction(y)
                  , n = t.objectStore(y)
                  , r = new w
                  , o = n.openCursor();
                ...
                o.onsuccess = function() {
                    ...
                    if (t) {
                        var n = t.value;
                        r.deleteToken(n.fcmSenderId, n.fcmToken, n.fcmPushSet),
                        t.continue()
                    } else
                        e.close(),
 ...
 */
        var T = function() {
            ...
            e.prototype.closeDatabase = function() {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    var e;
                    return Object(c["__generator"])(this, (function(t) {
                        switch (t.label) {
                        case 0:
            ...
            e.prototype.createTransaction = function(e, t) {
                ...
                Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    var n, r, o, i;
                    return Object(c["__generator"])(this, (function(s) {
                        switch (s.label) {
                        case 0:
                            return [4, this.getDb()];
                        case 1:
                            ...
                            o = r.objectStore(this.objectStoreName),
                            [4, S(e(o))];
                        case 2:
                            return i = s.sent(),
 ...
 */
        var O = function(e) {
            ...
            t.prototype.onDbUpgrade = function(e, t) {
                ...
                switch (t.oldVersion) {
                case 0:
                    var r = n.createObjectStore(this.objectStoreName, {
                        keyPath: "swScope"
                    });
                ...
                case 1:
                    m();
                case 2:
                    r = e.transaction.objectStore(this.objectStoreName);
                    var o = r.openCursor();
                    o.onsuccess = function() {
                        var e = o.result;
                        if (e) {
                            var t = e.value
                              , n = Object(c["__assign"])({}, t);
                            t.createTime || (n.createTime = Date.now()),
                            "string" === typeof t.vapidKey && (n.vapidKey = v(t.vapidKey)),
                            "string" === typeof t.auth && (n.auth = v(t.auth).buffer),
                            "string" === typeof t.auth && (n.p256dh = v(t.p256dh).buffer),
                            e.update(n),
                            e.continue()
                        }
                    }
            ...
            t.prototype.deleteToken = function(e) {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    var t;
                    return Object(c["__generator"])(this, (function(n) {
                        switch (n.label) {
                        case 0:
 ...
 */
        var P = 65
          , M = function(e) {
            ...
            t.prototype.onDbUpgrade = function(e) {
                var t = e.result;
                t.createObjectStore(this.objectStoreName, {
                    keyPath: "swScope"
                })
            }
            ,
            ...
            t.prototype.saveVapidDetails = function(e, t) {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    var n;
                    return Object(c["__generator"])(this, (function(r) {
                        if ("string" !== typeof e || 0 === e.length)
                            throw f.create("bad-scope");
                        if (null === t || t.length !== P)
                            throw f.create("bad-vapid-key");
                        return n = {
                            swScope: e,
                            vapidKey: t
          ...
          , C = function() {
            function e(e) {
                var t = this;
                if (!e.options[D] || "string" !== typeof e.options[D])
                    throw f.create("bad-sender-id");
                this.messagingSenderId = e.options[D],
                this.tokenDetailsModel = new O,
                this.vapidDetailsModel = new M,
                this.iidModel = new w,
                this.app = e,
                this.INTERNAL = {
                    delete: function() {
            ...
            return e.prototype.getToken = function() {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    var e, t, n, r, o;
                    return Object(c["__generator"])(this, (function(i) {
                        switch (i.label) {
                        case 0:
                            if (e = this.getNotificationPermission_(),
                            "denied" === e)
                        ...
                        case 4:
                            return o = i.sent(),
                            o ? [2, this.manageExistingToken(t, r, n, o)] : [2, this.getNewToken(t, r, n)]
                        }
                    }
                    ))
                }
                ...
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    ...
                    return Object(c["__generator"])(this, (function(s) {
                        ...
                        case 0:
                            return o = N(t, n, r),
                            o ? (i = Date.now(),
                            i < r.createTime + I ? [2, r.fcmToken] : [2, this.updateToken(e, t, n, r)]) : [4, this.deleteTokenFromDB(r.fcmToken)];
                        case 1:
                            return s.sent(),
            ...
            e.prototype.deleteToken = function(e) {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    ...
                    return Object(c["__generator"])(this, (function(r) {
                        ...
                        case 2:
                            return t = r.sent(),
                            t ? [4, t.pushManager.getSubscription()] : [3, 4];
                        case 3:
                            if (n = r.sent(),
                            n)
            ...
            e.prototype.delete = function() {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    return Object(c["__generator"])(this, (function(e) {
                        switch (e.label) {
                        case 0:
        ...
        function N(e, t, n) {
            if (!n.vapidKey || !p(t.buffer, n.vapidKey.buffer))
                return !1;
          ...
          , V = function(e) {
            ...
            t.prototype.onPush_ = function(e) {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    ...
                    return Object(c["__generator"])(this, (function(c) {
                        ...
                        case 1:
                            return n = c.sent(),
                            n ? [2, this.sendMessageToWindowClients_(t)] : (r = this.getNotificationData_(t),
                            r ? (o = r.title || "",
            ...
            t.prototype.onSubChange_ = function(e) {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    ...
                    return Object(c["__generator"])(this, (function(i) {
                        ...
                        case 5:
                            return n = i.sent(),
                            r = this.getTokenDetailsModel(),
                            [4, r.getTokenDetailsFromSWScope(e.scope)];
                        case 6:
                            if (o = i.sent(),
                            !o)
                                throw n;
            ...
            t.prototype.onNotificationClick_ = function(e) {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    ...
                    return Object(c["__generator"])(this, (function(s) {
                        switch (s.label) {
                        case 0:
                            return e.notification && e.notification.data && e.notification.data[K] ? e.action ? [2] : (e.stopImmediatePropagation(),
                            e.notification.close(),
                            t = e.notification.data[K],
                            t.notification ? (n = t.fcmOptions && t.fcmOptions.link || t.notification.click_action,
                            n ? [4, this.getWindowClient_(n)] : [2]) : [2]) : [2];
                        case 1:
                            return r = s.sent(),
                            r ? [3, 3] : [4, self.clients.openWindow(n)];
                        case 2:
                            return r = s.sent(),
                            [3, 5];
                        case 3:
                        ...
                        case 5:
                            ...
                            delete t.fcmOptions,
                            o = W(i.NOTIFICATION_CLICKED, t),
                            [2, this.attemptToMessageClient_(r, o)]) : [2]
                        }
                    }
                    ))
                }
            ...
            t.prototype.getNotificationData_ = function(e) {
                ...
                if (e && "object" === typeof e.notification) {
                    var n = Object(c["__assign"])({}, e.notification);
                    return n.data = Object(c["__assign"])({}, e.notification.data, (t = {},
                    t[K] = e,
                    t)),
                    n
                }
                ...
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    ...
                    return Object(c["__generator"])(this, (function(s) {
                        ...
                        case 1:
                            ...
                            r = null,
                            o = 0; o < n.length; o++)
                                if (i = new URL(n[o].url,self.location.href).href,
                                i === t) {
                                    r = n[o];
                                    break
                                }
 ...
 */
        ...
        var F = "/firebase-messaging-sw.js"
          , U = "/firebase-cloud-messaging-push-scope"
          , x = function(e) {
            function t(t) {
                var n = e.call(this, t) || this;
                ...
                n.onMessageInternal = Object(u["createSubscribe"])((function(e) {
                    n.messageObserver = e
                }
                )),
                n.onTokenRefreshInternal = Object(u["createSubscribe"])((function(e) {
            ...
            t.prototype.getPublicVapidKey_ = function() {
                return Object(c["__awaiter"])(this, void 0, void 0, (function() {
                    return Object(c["__generator"])(this, (function(e) {
                        return this.publicVapidKeyToUse ? [2, this.publicVapidKeyToUse] : [2, h]
                    }
                    ))
                }
                ))
            ...
            t.prototype.setupSWMessageListener_ = function() {
                ...
                navigator.serviceWorker.addEventListener("message", (function(t) {
                    if (t.data && t.data[o.TYPE_OF_MSG]) {
                        var n = t.data;
                        switch (n[o.TYPE_OF_MSG]) {
                        case i.PUSH_MSG_RECEIVED:
 ...
 */
        function E(e) {
            var t = "messaging"
              , n = function(e) {
                ...
                return self && "ServiceWorkerGlobalScope"in self ? new V(e) : new x(e)
            }
              , r = {
                isSupported: R
            };
        ...
        function R() {
            return self && "ServiceWorkerGlobalScope"in self ? H() : L()
        }
        function L() {
