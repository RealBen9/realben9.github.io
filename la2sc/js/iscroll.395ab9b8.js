(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["iscroll"], {
    "54af": function(t, i, s) {
        var e;
        ...
        (function(o, n, r) {
            var h = o.requestAnimationFrame || o.webkitRequestAnimationFrame || o.mozRequestAnimationFrame || o.oRequestAnimationFrame || o.msRequestAnimationFrame || function(t) {
              ...
              , a = function() {
                var t = {}
                  ...
                  , s = function() {
                    for (var t, s = ["t", "webkitT", "MozT", "msT", "OT"], e = 0, o = s.length; e < o; e++)
                        if (t = s[e] + "ransform",
                        t in i)
                            return s[e].substr(0, s[e].length - 1);
                    return !1
                }();
                function e(t) {
                ...
                ,
                t.addEvent = function(t, i, s, e) {
                    t.addEventListener(i, s, !!e)
                }
                ,
                t.removeEvent = function(t, i, s, e) {
                ...
                ,
                t.momentum = function(t, i, s, e, o, n) {
                    var h, a, l = t - i, c = r.abs(l) / s;
                    return n = void 0 === n ? 6e-4 : n,
                    h = t + c * c / (2 * n) * (l < 0 ? -1 : 1),
                    a = c / n,
                    h < e ? (h = o ? e - o / 2.5 * (c / 8) : e,
                    l = r.abs(h - t),
                    a = l / c) : h > 0 && (h = o ? o / 2.5 * (c / 8) : 0,
                    l = r.abs(t) + h,
                    a = l / c),
                    {
                ...
                ,
                t.addClass = function(i, s) {
                    if (!t.hasClass(i, s)) {
                        var e = i.className.split(" ");
                        e.push(s),
                        i.className = e.join(" ")
                    }
                }
                ,
                t.removeClass = function(i, s) {
                    if (t.hasClass(i, s)) {
                ...
                t.extend(t.ease = {}, {
                    ...
                    elastic: {
                        ...
                        fn: function(t) {
                            var i = .22
                              , s = .4;
                            return 0 === t ? 0 : 1 == t ? 1 : s * r.pow(2, -10 * t) * r.sin((t - i / 4) * (2 * r.PI) / i) + 1
                        }
                    }
                }),
                t.tap = function(t, i) {
                ...
                t.click = function(t) {
                    var i, s = t.target;
                    /(SELECT|INPUT|TEXTAREA)/i.test(s.tagName) || (i = n.createEvent("MouseEvents"),
                    i.initMouseEvent("click", !0, !0, t.view, 1, s.screenX, s.screenY, s.clientX, s.clientY, t.ctrlKey, t.altKey, t.shiftKey, t.metaKey, 0, null),
                    i._constructed = !0,
                    s.dispatchEvent(i))
                }
                ,
            ...
            function c(t, i, s) {
                ...
                "h" == t ? (!0 === s && (e.style.cssText += ";height:7px;left:2px;right:2px;bottom:0",
                o.style.height = "100%"),
                e.className = "iScrollHorizontalScrollbar") : (!0 === s && (e.style.cssText += ";width:7px;bottom:2px;top:2px;right:1px",
                o.style.width = "100%"),
            ...
            function p(t, i) {
                ...
                this.options.fade) {
                    ...
                    this.wrapperStyle[e] = a.isBadAndroid ? "0.0001ms" : "0ms";
                    var r = this;
                    a.isBadAndroid && h((function() {
            ...
            l.prototype = {
                ...
                _start: function(t) {
                    var i;
                    if (1 != a.eventType[t.type] && (i = t.which ? t.button : t.button < 2 ? 0 : 4 == t.button ? 1 : 2,
                    0 !== i))
                        return;
                    if (this.enabled && (!this.initiated || a.eventType[t.type] === this.initiated)) {
                        !this.options.preventDefault || a.isBadAndroid || a.preventDefaultException(t.target, this.options.preventDefaultException) || t.preventDefault();
                        var s, e = t.touches ? t.touches[0] : t;
                        ...
                        this._translate(r.round(s.x), r.round(s.y)),
                ...
                _move: function(t) {
                    if (this.enabled && a.eventType[t.type] === this.initiated) {
                        ...
                        var i, s, e, o, n = t.touches ? t.touches[0] : t, h = n.pageX - this.pointX, l = n.pageY - this.pointY, c = a.getTime();
                        ...
                        !(c - this.endTime > 300 && e < 10 && o < 10)) {
                            ...
                            i = this.x + h,
                            s = this.y + l,
                            (i > 0 || i < this.maxScrollX) && (i = this.options.bounce ? this.x + h / 3 : i > 0 ? 0 : this.maxScrollX),
                ...
                _end: function(t) {
                    if (this.enabled && a.eventType[t.type] === this.initiated) {
                        ...
                        var i, s, e = a.getTime() - this.startTime, o = r.round(this.x), n = r.round(this.y), h = r.abs(o - this.startX), l = r.abs(n - this.startY), c = 0, p = "";
                        ...
                        !this.resetPosition(this.options.bounceTime)) {
                            ...
                            if (this._events.flick && e < 200 && h < 100 && l < 100)
                                this._execEvent("flick");
                            else {
                                if (this.options.momentum && e < 300 && (i = this.hasHorizontalScroll ? a.momentum(this.x, this.startX, e, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : {
                                    destination: o,
                                    duration: 0
                                },
                                s = this.hasVerticalScroll ? a.momentum(this.y, this.startY, e, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options.deceleration) : {
                                    destination: n,
                                    duration: 0
                                },
                                o = i.destination,
                                n = s.destination,
                                c = r.max(i.duration, s.duration),
                                this.isInTransition = 1),
                                this.options.snap) {
                                    var d = this._nearestSnap(o, n);
                                    this.currentPage = d,
                                    c = this.options.snapSpeed || r.max(r.max(r.min(r.abs(o - d.x), 1e3), r.min(r.abs(n - d.y), 1e3)), 300),
                                    o = d.x,
                                    n = d.y,
                                    this.directionX = 0,
                                    this.directionY = 0,
                                ...
                                if (o != this.x || n != this.y)
                                    return (o > 0 || o < this.maxScrollX || n > 0 || n < this.maxScrollY) && (p = a.ease.quadratic),
                ...
                scrollToElement: function(t, i, s, e, o) {
                    ...
                    t) {
                        ...
                        !0 === s && (s = r.round(t.offsetWidth / 2 - this.wrapper.offsetWidth / 2)),
                        !0 === e && (e = r.round(t.offsetHeight / 2 - this.wrapper.offsetHeight / 2)),
                        n.left -= s || 0,
                        n.top -= e || 0,
                        ...
                        i = void 0 === i || null === i || "auto" === i ? r.max(r.abs(this.x - n.left), r.abs(this.y - n.top)) : i,
                ...
                _translate: function(t, i) {
                    if (this.options.useTransform ? this.scrollerStyle[a.style.transform] = "translate(" + t + "px," + i + "px)" + this.translateZ : (t = r.round(t),
                    i = r.round(i),
                ...
                getComputedPosition: function() {
                    ...
                    return this.options.useTransform ? (s = s[a.style.transform].split(")")[0].split(", "),
                    t = +(s[12] || s[4]),
                ...
                _initIndicators: function() {
                    ...
                    for (var n = e.length; n--; )
                        this.indicators.push(new p(this,e[n]));
                    function r(t) {
                        if (o.indicators)
                ...
                _wheel: function(t) {
                    if (this.enabled) {
                        ...
                        e = this.x + r.round(this.hasHorizontalScroll ? i : 0),
                        o = this.y + r.round(this.hasVerticalScroll ? s : 0),
                ...
                _initSnap: function() {
                    ...
                    this.on("refresh", (function() {
                        var t, i, s, e, o, n, h = 0, a = 0, l = 0, c = this.options.snapStepX || this.wrapperWidth, p = this.options.snapStepY || this.wrapperHeight;
                        if (this.pages = [],
                        this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight) {
                            if (!0 === this.options.snap) {
                                s = r.round(c / 2),
                                e = r.round(p / 2);
                                while (l > -this.scrollerWidth) {
                                    this.pages[h] = [],
                                    t = 0,
                                    o = 0;
                                ...
                                for (n = this.options.snap,
                                t = n.length,
                                i = -1; h < t; h++)
                                    (0 === h || n[h].offsetLeft <= n[h - 1].offsetLeft) && (a = 0,
                                    i++),
                                    this.pages[a] || (this.pages[a] = []),
                                    l = r.max(-n[h].offsetLeft, this.maxScrollX),
                                    o = r.max(-n[h].offsetTop, this.maxScrollY),
                                    s = l - r.round(n[h].offsetWidth / 2),
                                    e = o - r.round(n[h].offsetHeight / 2),
                                    this.pages[a][i] = {
                                        x: l,
                                        y: o,
                            ...
                            this.snapThresholdY = this.options.snapThreshold) : (this.snapThresholdX = r.round(this.pages[this.currentPage.pageX][this.currentPage.pageY].width * this.options.snapThreshold),
                ...
                _nearestSnap: function(t, i) {
                    ...
                    var s = 0
                      , e = this.pages.length
                      , o = 0;
                    if (r.abs(t - this.absStartX) < this.snapThresholdX && r.abs(i - this.absStartY) < this.snapThresholdY)
                        return this.currentPage;
                    for (t > 0 ? t = 0 : t < this.maxScrollX && (t = this.maxScrollX),
                    i > 0 ? i = 0 : i < this.maxScrollY && (i = this.maxScrollY); s < e; s++)
                ...
                goToPage: function(t, i, s, e) {
                    ...
                    var o = this.pages[t][i].x
                      , n = this.pages[t][i].y;
                    s = void 0 === s ? this.options.snapSpeed || r.max(r.max(r.min(r.abs(o - this.x), 1e3), r.min(r.abs(n - this.y), 1e3)), 300) : s,
                    this.currentPage = {
                        x: o,
                        y: n,
                        pageX: t,
                ...
                _key: function(t) {
                    if (this.enabled) {
                        var i, s = this.options.snap, e = s ? this.currentPage.pageX : this.x, o = s ? this.currentPage.pageY : this.y, n = a.getTime(), h = this.keyTime || 0, l = .25;
                        switch (this.options.useTransition && this.isInTransition && (i = this.getComputedPosition(),
                        this._translate(r.round(i.x), r.round(i.y)),
                        this.isInTransition = !1),
                        this.keyAcceleration = n - h < 200 ? r.min(this.keyAcceleration + l, 50) : 0,
                        t.keyCode) {
            ...
            p.prototype = {
                ...
                _start: function(t) {
                    ...
                    this.options.disablePointer || a.addEvent(o, a.prefixPointerEvent("pointermove"), this),
                    this.options.disableMouse || a.addEvent(o, "mousemove", this),
                    this.scroller._execEvent("beforeScrollStart")
                },
                _move: function(t) {
                    var i, s, e, o, n = t.touches ? t.touches[0] : t, r = a.getTime();
                ...
                refresh: function() {
                    ...
                    this.options.resize ? (this.indicatorWidth = r.max(r.round(this.wrapperWidth * this.wrapperWidth / (this.scroller.scrollerWidth || this.wrapperWidth || 1)), 8),
                    ...
                    this.options.resize ? (this.indicatorHeight = r.max(r.round(this.wrapperHeight * this.wrapperHeight / (this.scroller.scrollerHeight || this.wrapperHeight || 1)), 8),
                ...
                updatePosition: function() {
                    ...
                    this.options.ignoreBoundaries || (t < this.minBoundaryX ? ("scale" == this.options.shrink && (this.width = r.max(this.indicatorWidth + t, 8),
                    this.indicatorStyle.width = this.width + "px"),
                    t = this.minBoundaryX) : t > this.maxBoundaryX ? "scale" == this.options.shrink ? (this.width = r.max(this.indicatorWidth - (t - this.maxPosX), 8),
                    this.indicatorStyle.width = this.width + "px",
                    ...
                    this.indicatorStyle.width = this.width + "px"),
                    i < this.minBoundaryY ? ("scale" == this.options.shrink && (this.height = r.max(this.indicatorHeight + 3 * i, 8),
                    this.indicatorStyle.height = this.height + "px"),
                    i = this.minBoundaryY) : i > this.maxBoundaryY ? "scale" == this.options.shrink ? (this.height = r.max(this.indicatorHeight - 3 * (i - this.maxPosY), 8),
                    this.indicatorStyle.height = this.height + "px",
                    ...
                    this.x = t,
                    this.y = i,
                    this.scroller.options.useTransform ? this.indicatorStyle[a.style.transform] = "translate(" + t + "px," + i + "px)" + this.scroller.translateZ : (this.indicatorStyle.left = t + "px",
                    this.indicatorStyle.top = i + "px")
                },
                _pos: function(t, i) {
                    t < 0 ? t = 0 : t > this.maxPosX && (t = this.maxPosX),
                    i < 0 ? i = 0 : i > this.maxPosY && (i = this.maxPosY),
                    t = this.options.listenX ? r.round(t / this.sizeRatioX) : this.scroller.x,
                    i = this.options.listenY ? r.round(i / this.sizeRatioY) : this.scroller.y,
                ...
                fade: function(t, i) {
                    if (!i || this.visible) {
                        ...
                        var s = t ? 250 : 500
                          , e = t ? 0 : 300;
                        t = t ? "1" : "0",
                        this.wrapperStyle[a.style.transitionDuration] = s + "ms",
            ...
            l.utils = a,
            t.exports ? t.exports = l : (e = function() {
                return l
            }
            .call(i, s, i, t),
    ...
    a59a: function(t, i, s) {
        ...
        function r(t, i) {
            const s = "undefined" !== typeof t && "undefined" !== typeof i;
            s && 0 !== this.wrapperHeight ? this.scrollerHeight = i : (this.wrapper.offsetHeight,
            this.wrapperHeight = this.wrapper.clientHeight,
            this.scrollerHeight = this.scroller.offsetHeight),
            this.maxScrollY = this.wrapperHeight - this.scrollerHeight,
            this.hasVerticalScroll = this.options.scrollY && this.maxScrollY < 0,
            ...
            this.directionX = 0,
            this.directionY = 0,
            s || (this.wrapperOffset = n(this.wrapper)),
            this._execEvent("refresh"),
            this.resetPosition()
        }
        o.a.prototype.refresh = r;
        const {_start: h} = o.a.prototype;
        function a(t) {
            "IMG" !== t.target.tagName && h.call(this, t)
        }
        o.a.prototype._start = a,
        i["default"] = o.a
    }
}]);
//# sourceMappingURL=iscroll.395ab9b8.js.map
